...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900">
      {/* Modern Navigation */}
      {!hideNavigation && (
        <nav className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-white/20 dark:border-slate-800 sticky top-0 z-50 shadow-lg shadow-blue-500/5">
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden lg:flex items-center space-x-1">
                ...
                <div className="flex items-center space-x-2 ml-4">
                  ...
                  <motion.button 
                    ...
                    className="p-2 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-slate-800 transition-all duration-200" 
                  ...
                  <div className="relative">
                    <details className="group">
                      <summary className="list-none cursor-pointer p-2 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-slate-800 flex items-center gap-2 transition-all duration-200">
                        <Bell size={18} />
                        {unreadCount > 0 && (
                          <span className="absolute -top-1 -right-1 text-xs bg-red-500 text-white px-1.5 py-0.5 rounded-full animate-pulse min-w-[20px] text-center">
                            {unreadCount}
                          </span>
                        )}
                      </summary>
                          ...
                          {notifications.length === 0 ? (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="truncate flex-1">{n.message}</div>
                                <div className="text-[10px] text-slate-500 ml-2">{new Date(n.at).toLocaleTimeString()}</div>
                              </div>
                            </motion.div>
                          ))}
                        </div>
                  ...
                  {user && (
                    <div className="relative">
                      <details className="group">
                        <summary className="list-none cursor-pointer flex items-center space-x-2 p-2 rounded-xl hover:bg-blue-50 dark:hover:bg-slate-800 transition-all duration-200">
                        ...
                        <motion.div 
                          initial={{ opacity: 0, y: -10 }}
                          animate={{ opacity: 1, y: 0 }}
                          className="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl p-2 z-50"
                        >
                          ...
                          {userMenuItems.map((item) => (
                            <Link
                              key={item.to}
                              to={item.to}
                              className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
                            >
                              <span>{item.icon}</span>
                          ...
                          <button
                            ...
                            className="flex items-center space-x-2 w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
                          >
                            <LogOut size={16} />
                            <span>Logout</span>
                          </button>
              ...
              <div className="lg:hidden">
                <button 
                  ...
                  className="p-2 rounded-lg text-gray-600 dark:text-slate-300 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-slate-800 transition-all duration-200"
                      ...
                      <>
                        ...
                        {userMenuItems.map((item) => (
                          <Link
                            ...
                            to={item.to}
                            onClick={() => setMobileMenuOpen(false)}
                            className="flex items-center space-x-3 px-3 py-2 rounded-xl text-sm font-medium text-gray-600 dark:text-slate-300 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-slate-800 transition-all duration-200"
                          >
                            <span>{item.icon}</span>
                            <span>{item.label}</span>
                          </Link>
                        ...
                        <button
                          onClick={handleLogout}
                          className="flex items-center space-x-3 w-full px-3 py-2 rounded-xl text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200"
                        >
                          <LogOut size={16} />
                          <span>Logout</span>
                        </button>
      ...
      <main className="relative">
        ...
        {!hideNavigation && (
          <motion.button 
            ...
            className="fixed bottom-6 right-6 w-14 h-14 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-2xl hover:scale-110 active:scale-95 transition-transform focus:outline-none focus:ring-4 focus:ring-blue-500/25 z-40"
          ...
          {assistantOpen && (
            ...
            >
              ...
              <motion.div 
                ...
                className="relative w-full sm:max-w-md bg-white dark:bg-slate-900 rounded-t-2xl sm:rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 p-4 max-h-[80vh] flex flex-col"
              >
                ...
                <div className="flex-1 overflow-y-auto rounded-lg border border-slate-200 dark:border-slate-800 p-3 bg-slate-50 dark:bg-slate-800 mb-3" id="assistant-messages">
